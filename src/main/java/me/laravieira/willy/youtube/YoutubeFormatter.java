...
public class YoutubeFormatter {
	...
	private final Queue<Integer> avBestQualities = new LinkedList<Integer>();
	private final Queue<Integer> avGoodQualities = new LinkedList<Integer>();
	private final Queue<Integer> avHalfQualities = new LinkedList<Integer>();
	private final Queue<Integer> avPoorQualities = new LinkedList<Integer>();
	
	private final Queue<Integer> vBestQualities = new LinkedList<Integer>();
	private final Queue<Integer> vGoodQualities = new LinkedList<Integer>();
	private final Queue<Integer> vHalfQualities = new LinkedList<Integer>();
	private final Queue<Integer> vPoorQualities = new LinkedList<Integer>();
	
	private final Queue<Integer> aBestQualities = new LinkedList<Integer>();
	private final Queue<Integer> aGoodQualities = new LinkedList<Integer>();
	private final Queue<Integer> aPoorQualities = new LinkedList<Integer>();
